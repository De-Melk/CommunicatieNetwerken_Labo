...
sock.bind((socket.gethostname(),50020))     #"To fill up"
                                            #original port for receiving from server 
...
sock.bind((socket.gethostname(),50021)) #"To fill up"
...
sock = socket.socket(socket.AF_INET , socket.SOCK_DGRAM) #"To fill up"
sock.bind((socket.gethostname(),50022)) #"To fill up"
